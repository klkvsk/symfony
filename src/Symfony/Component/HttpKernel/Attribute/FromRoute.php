...
/**
 * Controller argument tag forcing ValueResolvers to use the value from request's route attributes.
 */
#[\Attribute(\Attribute::TARGET_PARAMETER | \Attribute::IS_REPEATABLE)]
class FromRoute extends ValueBagResolver
{
    /**
    ...
    {
        parent::__construct('attributes', $name, $filter, $options);
    }
}
