...
/**
 * Controller argument tag forcing ValueResolvers to use the value from request's query.
 *
 * @author Mike Kulakovsky <mike@kulakovs.ky>
 */
#[\Attribute(\Attribute::TARGET_PARAMETER)]
class FromQuery extends FromRequestParameter
{
    /**
     * @param string|null $name The name of query parameter. Use "*" to collect all parameters. By default, the name of the argument in the controller will be used.
    ...
    {
        parent::__construct('query', $name, $filter, $options, $throwOnFilterFailure);
    }
}
